...
POPULATION_SIZE = 15  # количество геномов (рекомендуется 10)
MUTA_RATE = 0.3  # вероятность мутации (рекомендуется 0.3)
ROTATIONS = 4  # выбор вращения, 1: нет вращения
# Единица MM (мм)
SPACING = 3  # графический интервал между контурами
...
CONTOUR_SCALING = 9.5  # установите 1, если не надо масштабировать
